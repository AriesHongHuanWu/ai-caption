...
/* ──────────────────────────────────────────────────────────────────────────
   ...
   USAGE (run from anywhere; paths are resolved relative to this script):
     node scripts/make-latest-json.mjs \
       ...
       [--repo AriesHongHuanWu/LocalAiLyrics] \
   ...
   ARGS (all optional except where noted):
     ...
     --repo <owner/repo> GitHub "owner/repo". Default: AriesHongHuanWu/LocalAiLyrics.
...
const DEFAULT_REPO = 'AriesHongHuanWu/LocalAiLyrics';
