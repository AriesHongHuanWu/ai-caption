...
(function () {
  ...
  const STRINGS = {
    zh: {
      ...
      // Hero
      'hero.eyebrow':  '免費 · 開源 · 本地優先',
      'hero.tagline':  '任何一首歌，\n都能成為一頁精準歌詞。',
      'hero.sub':      '一鍵把音訊拆成逐字時間軸——LRC、SRT、ASS 卡拉 OK、JSON。Demucs 人聲分離 + faster-whisper 辨識 + 強制對齊，全跑在你自己的機器上，不上傳、不追蹤。',
      ...
      'feat.1.name':   '本地優先・不上傳',
      'feat.1.desc':   '音訊與歌詞永遠留在你的裝置上。沒有伺服器，沒有帳號，沒有隱私顧慮。',
      'feat.2.name':   '參考歌詞→接近完美',
      'feat.2.desc':   '貼入完整歌詞即啟動強制對齊（torchaudio MMS_FA + forced_align），準確度大幅超越純 ASR。',
      'feat.3.name':   '人聲分離提升準確度',
      'feat.3.desc':   'Demucs 先把人聲從伴奏中分離，讓 Whisper 只看乾淨人聲，低混音歌曲也適用。',
      'feat.4.name':   '逐字 QA 編輯介面',
      'feat.4.desc':   '黃金閱讀播放頭、信心色標、可拖拉邊界——用書本版面做 10 ms 精準修訂。',
      'feat.5.name':   '中英日韓 多語支援',
      'feat.5.desc':   'faster-whisper 大模型支援主流歌曲語言，CJK 字體自動選配。',
      'feat.6.name':   '匯出 LRC / SRT / ASS / JSON',
      'feat.6.desc':   '一鍵輸出四種格式；ASS 支援逐字 \\k 卡拉 OK，即時預覽再存檔。',

      // How
      'how.eyebrow':   '運作原理',
      'how.title':     '四步流水線，一氣呵成。',
      'how.sub':       '從音訊到時間軸，完全本地推理——模型一次下載，永久離線使用。',
      'step.1.num':    '① 人聲分離',
      'step.1.name':   'Demucs',
      ...
      // Who it's for
      'who.eyebrow':   '為誰打造',
      'who.title':     '不論你做什麼音樂工作，都適合。',
      'who.sub':       '從獨立製作到語言學習，AutoLyrics 讓逐字歌詞不再是門檻。',
      ...
      'cmp.eyebrow':        '與其他方式比較',
      'cmp.title':          '不藏私的誠實比較。',
      'cmp.sub':            'AutoLyrics 不是萬能的，但在本地、精確、免費這三點上，沒有妥協。',
      ...
      'dl.exe.desc':         'NSIS 封裝，雙擊安裝，含啟動精靈引導你安裝 Python 引擎與 AI 模型。',
      'dl.msi.fmt':          '.MSI 安裝包',
      'dl.msi.name':         'Windows MSI',
      'dl.msi.desc':         '適合企業部署或偏好 MSI 的使用者，同樣包含引擎安裝精靈。',
      'dl.zip.fmt':          '.ZIP 免安裝',
      'dl.zip.name':         'Windows Portable',
      'dl.zip.desc':         '解壓即用，不寫入登錄機碼。仍需首次啟動精靈安裝 Python 引擎。',
      ...
      'dl.note':             '<strong>首次啟動：</strong>安裝精靈會自動引導你安裝 Python 3.10–3.12 與 AI 模型（需要幾 GB 空間，僅下載一次）。',
      'dl.sysreq':           '需求：Windows 10/11 · 建議 NVIDIA GPU（CPU 亦可）· 8 GB RAM · 10 GB 磁碟空間',
      'dl.allreleases':      '所有版本 All releases →',

      // Roadmap
      'road.eyebrow':        '持續開發',
      'road.title':          '路線圖',
      'road.sub':            'AutoLyrics 仍在積極開發中——以下是正在進行或計劃中的項目。',
      ...
      'priv.p5':       '沒有第三方追蹤器',
      'priv.p6':       '完全在裝置本地執行',
      'priv.net':      '<span class="amber-dot"></span><strong>唯一的網路活動：</strong>當你選擇下載 AI 模型時，程式會從官方來源（Hugging Face、pytorch.org）取得模型檔案。除此之外，AutoLyrics 不向任何伺服器傳送任何使用資料。',
      ...
      'faq.eyebrow':   '常見問題',
      'faq.title':     '還有疑問？',
      'faq.q1':        'AutoLyrics 免費嗎？',
      'faq.a1':        '完全免費，MIT 開源授權。你可以自由使用、修改、再發布，商業用途亦可。',
      'faq.q2':        '它會上傳我的歌曲嗎？',
      'faq.a2':        '不會。所有音訊處理均在你的裝置本地完成。AutoLyrics 不與任何伺服器通訊，除非你主動觸發模型下載。',
      ...
      'faq.q5':        '一定需要 GPU 嗎？',
      'faq.a5':        '建議使用 NVIDIA GPU（RTX 系列最佳）以取得合理速度，但 CPU 模式仍可運作，只是速度較慢。Demucs + large-v3 在 GPU 上處理一首 4 分鐘歌曲約需 60–120 秒。',
      'faq.q6':        '模型有多大？需要下載多少？',
      'faq.a6':        'Demucs htdemucs 約 320 MB，faster-whisper large-v3 約 3.1 GB，torchaudio MMS_FA 對齊模型約 1.2 GB。首次使用需一次性下載，之後完全離線。',
      ...
      'cost.local.label':          'AutoLyrics（本地）',
      ...
      // Footer
      'foot.tagline':  'Built for musicians & lyric-video makers',
      'foot.license':  'MIT 授權',
      'foot.privacy':  '隱私政策',
    ...
    en: {
      ...
      'hero.eyebrow':  'Free · Open Source · Local-First',
      'hero.tagline':  'Any song becomes\na word-perfect lyric page.',
      'hero.sub':      'Export word-timed LRC, SRT, ASS-karaoke, or JSON from any audio file. Demucs vocal separation + faster-whisper recognition + forced alignment — all running on your own machine. No upload, no tracking.',
      'hero.cta.win':  'Download for Windows',
      'hero.cta.gh':   'GitHub',
      'hero.badge.1':  'MIT Open Source',
      'hero.badge.2':  '100% Local',
      'hero.badge.3':  'No Upload',
      'hero.badge.4':  'No Tracking',

      'mock.title':    'Transcribe · Edit · Export',
      'mock.status':   'GPU Ready',

      'feat.eyebrow':  'Six Highlights',
      'feat.title':    'Accurate, Private, Always Available.',
      'feat.sub':      'No account, no subscription, no internet required — install and go.',
      'feat.1.name':   'Local-First · No Upload',
      'feat.1.desc':   'Your audio and lyrics never leave your device. No server, no account, no privacy concerns.',
      'feat.2.name':   'Reference Lyrics → Near-Perfect',
      'feat.2.desc':   'Paste full lyrics to activate forced alignment (torchaudio MMS_FA + forced_align) — accuracy far beyond pure ASR.',
      'feat.3.name':   'Vocal Separation Boosts Accuracy',
      'feat.3.desc':   'Demucs isolates the vocal stem so Whisper processes clean audio — even heavily produced mixes.',
      'feat.4.name':   'Word-Level QA Editor',
      'feat.4.desc':   'Gold reading-playhead, confidence color, draggable boundaries — surgical 10 ms edits in a book-style layout.',
      'feat.5.name':   'Chinese · English · Japanese · Korean',
      'feat.5.desc':   'faster-whisper large-v3 covers all major song languages, with automatic CJK font matching.',
      'feat.6.name':   'Export LRC / SRT / ASS / JSON',
      'feat.6.desc':   'Four formats in one click. ASS includes per-word \\k karaoke sweep with live preview before saving.',

      'how.eyebrow':   'How It Works',
      'how.title':     'Four-Stage Pipeline, End to End.',
      'how.sub':       'From audio to timestamped lyrics — fully local inference. Models download once, work offline forever.',
      ...
      'modes.title':   'Three Modes — Pick What You Have',
      'mode.auto':     'Auto',
      ...
      'who.title':     'Whatever your music workflow, AutoLyrics fits.',
      'who.sub':       'From indie production to language study, word-level lyrics are no longer a bottleneck.',
      ...
      'cmp.sub':            'AutoLyrics isn\'t a magic bullet, but on privacy, precision, and price there\'s no compromise.',
      ...
      'dl.exe.desc':         'NSIS package. Double-click to install. A first-run wizard guides you through Python engine and AI model setup.',
      ...
      'dl.zip.name':         'Windows Portable',
      'dl.zip.desc':         'Extract and run — no installer, no registry writes. First-run wizard still needed to install the Python engine.',
      ...
      'dl.note':             '<strong>First launch:</strong> The setup wizard will guide you through installing Python 3.10–3.12 and downloading the AI models (a few GB, downloaded once).',
      'dl.sysreq':           'Requires: Windows 10/11 · NVIDIA GPU recommended (CPU supported) · 8 GB RAM · 10 GB disk space',
      'dl.allreleases':      'All releases →',

      // Roadmap
      'road.eyebrow':        'Active Development',
      'road.title':          'Roadmap',
      'road.sub':            'AutoLyrics is under active development — here\'s what\'s shipped and what\'s coming.',
      ...
      'priv.net':      '<span class="amber-dot"></span><strong>One honest exception:</strong> when you choose to download AI models, AutoLyrics fetches them from official sources (Hugging Face, pytorch.org). Beyond that, no usage data is sent anywhere.',
      'priv.date':     'Last updated: June 2026',
      'priv.full':     'Read the full Privacy Policy →',

      'faq.eyebrow':   'FAQ',
      'faq.title':     'Questions?',
      'faq.q1':        'Is AutoLyrics free?',
      'faq.a1':        'Completely free, MIT licensed. Use it, modify it, redistribute it — including for commercial purposes.',
      'faq.q2':        'Does it upload my songs?',
      'faq.a2':        'No. All audio processing happens locally on your device. AutoLyrics does not communicate with any server, except when you explicitly trigger a model download.',
      ...
      'faq.q5':        'Do I need a GPU?',
      'faq.a5':        'An NVIDIA GPU (RTX series preferred) is recommended for reasonable speed, but CPU mode works too — just slower. On GPU, a 4-minute song with Demucs + large-v3 takes about 60–120 seconds.',
      'faq.q6':        'How large are the models?',
      'faq.a6':        'Demucs htdemucs ~320 MB, faster-whisper large-v3 ~3.1 GB, torchaudio MMS_FA alignment model ~1.2 GB. Downloaded once on first use, then fully offline.',
      ...
      'cost.local.label':          'AutoLyrics (local)',
