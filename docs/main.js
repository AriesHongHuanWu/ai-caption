...
(function () {
  ...
  const STRINGS = {
    zh: {
      ...
      'feat.1.name':   '兩種模式・一個 App',
      'feat.1.desc':   '影片轉字幕（SRT / WebVTT）+ 歌曲轉逐字歌詞（LRC / ASS 卡拉 OK）。依檔案選模式，共用同一引擎。',
      'feat.2.name':   '參考歌詞→接近完美（歌詞模式）',
      'feat.2.desc':   '歌詞模式下貼入完整歌詞即啟動強制對齊（torchaudio MMS_FA + forced_align），準確度大幅超越純 ASR。',
      'feat.3.name':   '影片轉字幕・快速好用',
      'feat.3.desc':   '演講、Vlog、訪談、課程——丟檔即出乾淨字幕（SRT / WebVTT）。預設不做人聲分離，純語音更快。',
      'feat.4.name':   '逐字 QA 編輯介面',
      'feat.4.desc':   '黃金閱讀播放頭、信心色標、可拖拉邊界——用書本版面做 10 ms 精準修訂。',
      'feat.5.name':   '免獨立顯卡・筆電也快',
      'feat.5.desc':   '預設自動挑選適合 CPU 的 int8 模型，Core Ultra / Ryzen 筆電也能快速轉字幕。有 NVIDIA GPU 只會更快。',
      'feat.6.name':   '匯出字幕與歌詞・多語支援',
      'feat.6.desc':   '字幕匯出 SRT / WebVTT；歌詞匯出 LRC / SRT / ASS 逐字卡拉 OK / JSON。中英日韓多語，CJK 字體自動選配。',
    ...
    en: {
      ...
      'feat.1.name':   'Two Modes · One App',
      'feat.1.desc':   'Video → subtitles (SRT / WebVTT) and song → word-level lyrics (LRC / ASS karaoke). Pick the mode that fits the file — same engine.',
      'feat.2.name':   'Reference Lyrics → Near-Perfect (lyrics mode)',
      'feat.2.desc':   'In lyrics mode, paste full lyrics to activate forced alignment (torchaudio MMS_FA + forced_align) — accuracy far beyond pure ASR.',
      'feat.3.name':   'Video → Subtitles, Fast',
      'feat.3.desc':   'Talks, vlogs, interviews, lectures — drop a file and get clean captions (SRT / WebVTT). No vocal separation by default, so speech stays fast.',
      ...
      'feat.5.name':   'No Discrete GPU · Fast on Laptops',
      'feat.5.desc':   'Defaults auto-pick fast int8 models so a Core Ultra / Ryzen laptop transcribes captions quickly. An NVIDIA GPU just makes it faster.',
      'feat.6.name':   'Export Subtitles & Lyrics · Multilingual',
      'feat.6.desc':   'Subtitles as SRT / WebVTT; lyrics as LRC / SRT / ASS per-word \\k karaoke / JSON. Chinese · English · Japanese · Korean with automatic CJK fonts.',
