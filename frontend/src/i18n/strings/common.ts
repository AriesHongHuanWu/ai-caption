...
export const common: Record<string, Entry> = {
  ...
  'common.mode.downloadTitle': {
    ...
    en: 'Downloader — pull audio/video from YouTube & 1000s of sites; drag to a DAW, hand off to captions/lyrics, and deep-analyze key/BPM/structure/EQ/vocal-mix',
  },
  // ── Audio Toolbox (音訊工具箱) ──
  ...
  // ── Downloader + Song Analyzer (下載器) mode ──
  'download.title': { zh: '下載器 + 歌曲分析', en: 'Downloader + Song Analyzer' },
  'download.lede': {
    zh: '貼上 YouTube 或上千平台的網址 → 選音訊/影片格式下載 → 拖進 DAW、匯入字幕/歌詞分析,或直接深度分析這首歌。',
    en: 'Paste a URL (YouTube + 1000s of sites) → pick an audio/video format → drag into a DAW, hand off to captions/lyrics, or deep-analyze the track.',
  },
  'download.engineMissing': {
    zh: '下載器需要引擎內含 yt-dlp。新安裝會自動有;若你是從舊版更新,請到「設定 → 修復/重裝引擎」後再回來。',
    en: 'The downloader needs the engine to include yt-dlp. Fresh installs have it; if you updated from an older version, re-run Settings → repair/reinstall engine.',
  },
  ...
  'download.typeAudio': { zh: '音訊', en: 'Audio' },
  'download.typeVideo': { zh: '影片', en: 'Video' },
  'download.videoNone': { zh: '這個來源沒有可直接下載的影片格式。', en: 'No directly downloadable video format for this source.' },
  'download.unsupported': { zh: '不支援', en: 'Unsupported' },
  'download.needsMerge': {
    zh: '此解析度為純影像串流,需要系統 ffmpeg 合併音訊 —— 本機不內建,故不支援。請改選有標示的漸進式格式。',
    en: 'This resolution is a video-only stream that needs system ffmpeg to merge audio — not bundled, so unsupported. Pick a progressive format instead.',
  },
  'download.download': { zh: '下載', en: 'Download' },
  'download.downloading': { zh: '下載中…', en: 'Downloading…' },
  'download.savedTo': { zh: '已儲存到 {path}', en: 'Saved to {path}' },
  'download.drag': { zh: '拖到 DAW', en: 'Drag to DAW' },
  'download.dragHint': { zh: '按住拖曳這個檔案到 Ableton / Logic / Reaper 等 DAW 或任何 App。', en: 'Drag this file straight into Ableton / Logic / Reaper or any app.' },
  'download.reveal': { zh: '在資料夾顯示', en: 'Show in folder' },
  'download.saveAs': { zh: '另存新檔', en: 'Save as…' },
  'download.toVideo': { zh: '→ 影片字幕分析', en: '→ Video subtitles' },
  'download.toSong': { zh: '→ 歌詞字幕分析', en: '→ Song lyrics' },
  'download.handoffHint': {
    zh: '匯入後會切到該模式並自動載入這個檔案,按「開始」即可分析。',
    en: 'Hands the file to that mode pre-loaded — just hit Run to analyze.',
  },
  'download.analyze': { zh: '深度分析這首歌', en: 'Analyze this track' },
  'download.analyzing': { zh: '分析中…', en: 'Analyzing…' },
  'download.history': { zh: '下載紀錄', en: 'Download history' },
  'download.clearHistory': { zh: '清除', en: 'Clear' },
  'download.remove': { zh: '移除', en: 'Remove' },
  'download.err.generic': { zh: '下載/分析失敗,請確認網址或稍後再試。', en: 'Download/analysis failed — check the URL or try again.' },
  // analysis panel
  'download.an.key': { zh: '調性', en: 'Key' },
  'download.an.tempo': { zh: '速度', en: 'Tempo' },
  'download.an.genre': { zh: '曲風', en: 'Genre' },
  'download.an.loud': { zh: '響度', en: 'Loudness' },
  'download.an.match': { zh: '吻合度', en: 'match' },
  'download.an.conf': { zh: '信心', en: 'confidence' },
  'download.an.alt': { zh: '可能也是', en: 'Could be' },
  'download.an.compose': { zh: '作曲 — 音階與和弦', en: 'Compose — scale & chords' },
  'download.an.progressions': { zh: '常用進行', en: 'Common progressions' },
  'download.an.click': { zh: '節拍器', en: 'Click track' },
  'download.an.clickHint': { zh: '下載這個 BPM 的節拍器 click,用來對拍寫/錄。', en: 'Download a metronome click at this BPM to write/record in time.' },
  'download.an.structure': { zh: '曲式結構', en: 'Song structure' },
  'download.an.eqdist': { zh: '全曲 EQ 分布', en: 'Whole-song EQ balance' },
  'download.an.elements': { zh: '聲音元素', en: 'Sound elements' },
  'download.an.vocalmix': { zh: '人聲混音建議', en: 'Vocal mixing advice' },
  'download.mode.major': { zh: '大調', en: 'major' },
  'download.mode.minor': { zh: '小調', en: 'minor' },
  // section labels
  'download.sect.intro': { zh: '前奏', en: 'Intro' },
  'download.sect.verse': { zh: '主歌', en: 'Verse' },
  'download.sect.prechorus': { zh: '前副歌', en: 'Pre-chorus' },
  'download.sect.chorus': { zh: '副歌', en: 'Chorus' },
  'download.sect.bridge': { zh: '橋段', en: 'Bridge' },
  'download.sect.outro': { zh: '尾奏', en: 'Outro' },
  'download.sect.instrumental': { zh: '間奏/演奏', en: 'Instrumental' },
  'download.sect.aria': { zh: '歌曲波形與曲式段落', en: 'Song waveform with structure sections' },
  'download.sect.decoding': { zh: '解析波形中…', en: 'Decoding waveform…' },
  'download.eq.aria': { zh: '全曲頻率分布', en: 'Whole-song frequency balance' },
  ...
  'master.loud.apple': { zh: 'Apple Music', en: 'Apple Music' },
  'master.loud.balanced': { zh: '平衡', en: 'Balanced' },
  'master.loud.social': { zh: '社群', en: 'Social' },
  'master.loud.club': { zh: 'Club / DJ', en: 'Club / DJ' },
  'master.loudDesc.streaming': { zh: 'Spotify / YouTube / TikTok', en: 'Spotify / YouTube / TikTok' },
  'master.loudDesc.apple': { zh: 'Apple / Sound Check 規格', en: 'Apple / Sound Check spec' },
  'master.loudDesc.balanced': { zh: '較動態、通用', en: 'More dynamic, all-round' },
  'master.loudDesc.social': { zh: 'SoundCloud / 較大聲', en: 'SoundCloud / louder' },
  'master.loudDesc.club': { zh: '很響,DJ/夜店播放', en: 'Very loud, DJ/club play' },
  'master.compliance.pass': { zh: '符合交付規格', en: 'Meets delivery spec' },
  'master.compliance.fail': { zh: '未完全符合規格', en: 'Not fully on spec' },
  ...
  'master.stem.toggle': { zh: 'AI 分軌重新平衡(Demucs)', en: 'AI stem rebalance (Demucs)' },
  'master.stem.hint': {
    zh: 'AI 把混音拆成鼓/貝斯/人聲/其他 4 軌,各自調整音量再重新混合進母帶。可救「人聲太小、低音太多」的混音。',
    en: 'AI splits the mix into drums/bass/vocals/other, rebalances their levels, then masters the result. Rescues mixes where vocals are buried or the low end is too heavy.',
  },
  'master.stem.drums': { zh: '🥁 鼓', en: '🥁 Drums' },
  'master.stem.bass': { zh: '🎸 貝斯', en: '🎸 Bass' },
  'master.stem.vocals': { zh: '🎤 人聲', en: '🎤 Vocals' },
  'master.stem.other': { zh: '🎹 其他', en: '🎹 Other' },
  'master.stem.note': {
    zh: '⏱️ 分軌需要 GPU/CPU 運算,約 1–3 分鐘。全部 0dB 會自動跳過(不浪費時間)。',
    en: '⏱️ Separation takes ~1–3 min (GPU/CPU). All-zero gains are skipped automatically.',
  },
  'master.stem.unavailable': {
    zh: '此機器未安裝 Demucs,AI 分軌不可用(到設定安裝引擎以啟用)。',
    en: 'Demucs is not installed on this machine — AI stem rebalance is unavailable (install the engine in Settings).',
  },
  'master.stem.applied': { zh: '🎚️ 已分軌重新平衡:', en: '🎚️ Stems rebalanced:' },
  'master.stem.none': { zh: '原始平衡', en: 'original balance' },
  'master.stem.skipped': {
    zh: '⚠️ 分軌已跳過(AI 不可用或失敗)—— 這次用了原始混音,未套用分軌增益。',
    en: '⚠️ Stem rebalance was skipped (AI unavailable/failed) — the original mix was used, stem gains not applied.',
  },
  'master.ai.detected': { zh: '🤖 AI 偵測曲風:', en: '🤖 AI detected genre:' },
  'master.ai.apply': { zh: '套用', en: 'Apply' },
