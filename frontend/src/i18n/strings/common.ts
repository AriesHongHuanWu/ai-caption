...
export const common: Record<string, Entry> = {
  ...
  'common.cat.home': { zh: '我的作品', en: 'My work' },
  'common.cat.get': { zh: '① 取得素材', en: '① Source' },
  'common.cat.audio': { zh: '② 音訊工作室', en: '② Audio studio' },
  'common.cat.video': { zh: '③ 影像工作室', en: '③ Visuals studio' },
  'common.cat.edit': { zh: '④ 剪輯與輸出', en: '④ Edit & export' },
  ...
  'common.mode.visualizer': { zh: '視覺化', en: 'Visualizer' },
  'common.mode.visualizerTitle': {
